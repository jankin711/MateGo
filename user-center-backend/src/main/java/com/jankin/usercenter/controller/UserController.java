...
import com.jankin.usercenter.model.domain.request.UserLoginRequest;
import com.jankin.usercenter.model.domain.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        ...
        String redisKey = String.format("matego:user:recommend:%s", loginUser.getId());
