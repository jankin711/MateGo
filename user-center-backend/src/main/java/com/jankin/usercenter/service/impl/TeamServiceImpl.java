...
import com.jankin.usercenter.model.enums.TeamStatusEnum;
...
import com.jankin.usercenter.mapper.TeamMapper;
...
import com.jankin.usercenter.vo.UserVO;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public long addTeam(Team team, User loginUser) {
        ...
        // 3.检验信息
        // (1)队伍人数>1且<=20
        int maxNum = Optional.ofNullable(team.getMaxNum()).orElse(0);// 如果为空，默认赋值为0
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("matego:join_team");
        try {
            // 抢到锁并执行
            while (true) {
